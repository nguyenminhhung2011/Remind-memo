...
class CommonAppSettingPref {
  ...
  static const String _payId = 'payId';
  ...
  static Future<bool> setPayId(String payId) async {
    return Preferences.setString(_payId, payId);
  }

  static String getPayId() {
    return Preferences.getString(_payId) ?? '';
  }
  ...
  static void removePayId() {
    Preferences.remove(_payId);
  }
